...
export const MILL: SceneDef = {
  ...
  shapes: [
    { kind: "polygon", points: [[-21.496, 39.146], [-125.54, 105.197], [78.491, 106.789], [77.741, 55.628], [26.363, 20.537], [25.362, -19.28], [1.86, -21.161], [-3.117, -18.052], [-14.404, -18.679], [-28.291, -18.932], [-33.373, -3.833]], depth: 1.5, color: "#9eb886", x: -1.671, z: 1.692, y: -1.5, tilt: [90, 0], name: "Land" },
    { kind: "polygon", points: [[-75.062, 116.165], [-20.678, 59.373], [52.616, 50.57], [95.666, 113.181], [147.596, 109.189], [202.37, -277.172], [-363.652, -1273.439], [-10000, -10000], [-1082.762, -98.331]], depth: 1, color: "#84b6d1", x: -18.967, z: -6.923, y: -1.52, tilt: [90, 0], name: "Water" },
  ],
  anchors: [
    { name: "center", x: 0, z: 1 },
